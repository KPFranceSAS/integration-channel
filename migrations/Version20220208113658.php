 ...
 */
final class Version20220208113658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amazon_return DROP customer_comments');
    }
