 ...
 */
final class Version20220207150901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amazon_reimbursement CHANGE currency currency_unit VARCHAR(255) NOT NULL');
    }
