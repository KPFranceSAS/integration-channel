 ...
 */
final class Version20220208113342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amazon_return CHANGE licence_plate_number license_plate_number VARCHAR(255) DEFAULT NULL');
    }
