 ...
 */
final class Version20220208110301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amazon_return ADD product_id INT NOT NULL');
        $this->addSql('ALTER TABLE amazon_return ADD CONSTRAINT FK_9FA78F184584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_9FA78F184584665A ON amazon_return (product_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amazon_return DROP FOREIGN KEY FK_9FA78F184584665A');
        $this->addSql('DROP INDEX IDX_9FA78F184584665A ON amazon_return');
        $this->addSql('ALTER TABLE amazon_return DROP product_id, CHANGE order_id order_id VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE sku sku VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE asin asin VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE fnsku fnsku VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE fulfillment_center_id fulfillment_center_id VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE detailed_disposition detailed_disposition VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE reason reason VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE status status VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE licence_plate_number licence_plate_number VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE customer_comments customer_comments VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
