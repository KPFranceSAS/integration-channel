 ...
 */
final class Version20220208110047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE amazon_return (id INT AUTO_INCREMENT NOT NULL, return_date DATETIME NOT NULL, order_id VARCHAR(255) NOT NULL, sku VARCHAR(255) NOT NULL, asin VARCHAR(255) NOT NULL, fnsku VARCHAR(255) NOT NULL, quantity INT NOT NULL, fulfillment_center_id VARCHAR(255) DEFAULT NULL, detailed_disposition VARCHAR(255) DEFAULT NULL, reason VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, licence_plate_number VARCHAR(255) DEFAULT NULL, customer_comments VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE amazon_return');
