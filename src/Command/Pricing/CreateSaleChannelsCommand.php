...
class CreateSaleChannelsCommand extends Command
{
    ...
    {
        $amrektplaces=[
            ['code'=>'amazon_es_kp', 'name'=>'Amazon.es KP France', 'countryCode'=>'ES', 'currencyCode'=>'EUR', 'company'=> BusinessCentralConnector::KP_FRANCE],
            ['code'=>'amazon_de_kp', 'name'=>'Amazon.de KP France', 'countryCode'=>'DE', 'currencyCode'=>'EUR', 'company'=> BusinessCentralConnector::KP_FRANCE],
            ['code'=>'amazon_it_kp', 'name'=>'Amazon.it KP France', 'countryCode'=>'IT', 'currencyCode'=>'EUR', 'company'=> BusinessCentralConnector::KP_FRANCE],
            ['code'=>'amazon_uk_kp', 'name'=>'Amazon.uk KP France', 'countryCode'=>'GB', 'currencyCode'=>'GBP', 'company'=> BusinessCentralConnector::KP_FRANCE],
            ['code'=>'amazon_fr_kp', 'name'=>'Amazon.fr KP France', 'countryCode'=>'FR', 'currencyCode'=>'EUR', 'company'=> BusinessCentralConnector::KP_FRANCE],
           /*
            ['code'=>'amazon_es_gi', 'name'=>'Amazon.es Gadget Iberia', 'countryCode'=>'ES', 'currencyCode'=>'EUR', 'company'=> BusinessCentralConnector::GADGET_IBERIA],
