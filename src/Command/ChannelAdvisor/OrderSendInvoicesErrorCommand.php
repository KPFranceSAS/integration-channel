...
class OrderSendInvoicesErrorCommand extends Command
{
    protected static $defaultName = 'app:channel-send-invoices-error';
    protected static $defaultDescription = 'Send all orders in error transformed in invoices in the ERP';
