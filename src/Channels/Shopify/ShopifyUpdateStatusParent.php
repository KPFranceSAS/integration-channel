...
abstract class ShopifyUpdateStatusParent extends UpdateStatusParent
{
    ...
    protected function postUpdateStatusDelivery(WebOrder $order, $invoice, $trackingNumber)
    {
            ...
            $result = $this->getShopifyApi()->markAsFulfilled($jsonOrder['id'], $mainLocation['id'], $ids, $trackingNumber, 'https://clientesparcel.dhl.es/LiveTracking/ModificarEnvio/' .$trackingNumber);
            if ($result) {
